...
class SmartyCustom extends SmartyCustomCore
{
    ...
    {
        parent::__construct();
        $this->template_class = 'Trevenque_Smarty_Internal_Template';
        ...
        $this->is_mobile =  $this->is_mobile && !$this->is_tablet;
 ...
 * @author
 **/
class Trevenque_Smarty_Internal_Template extends Smarty_Custom_Template
{
    public function getSubTemplate($template, $cache_id, $compile_id, $caching, $cache_lifetime, $data, $parent_scope)
    {
        if (!$this->smarty->is_desktop) {
        ...
        if (!strpos($template, "custom") && is_file($custom_template)) {
            return parent::getSubTemplate($custom_template, $cache_id, $compile_id, $caching, $cache_lifetime, $data, $parent_scope);
        }
