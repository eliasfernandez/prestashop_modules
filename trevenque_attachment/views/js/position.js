...
if(typeof tObjToString !== 'function'){
	window.tObjToString = function(obj) {
		var str = '';
		for (var p in obj) {
...
if(typeof tInitTableDnD !== 'function'){
	console.debug("llego");
	window.tInitTableDnD = function(module_name, table_class) {
			...
			onDrop: function(table, row) {
				if (originalOrder != $.tableDnD.serialize()) {
					...
					$.ajax({
						...
						data: $.tableDnD.serialize() + '&' + tObjToString(params) ,
